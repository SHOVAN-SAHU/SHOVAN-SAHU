# 💫 About Me:
Hi there! 👋 I'm a backend developer focused on building fast, scalable APIs and reliable data pipelines[cite: 1]. <br><br>My work centers around system reliability, event-driven architecture, and AI integrations[cite: 1]. Lately, I've been deep in the weeds of building RAG and Agent-based projects, experimenting with modern retrieval techniques to make AI apps smarter, more accurate, and highly context-aware. <br><br>I care a lot about designing scalable systems, writing clean code, and turning big ideas into rock-solid backends. If you're building something interesting, let's connect! 🚀
...
![Bull.js](https://img.shields.io/badge/Bull.js-%23CE1141.svg?style=for-the-badge&logo=bull&logoColor=white)
